    ...
    return (
        <div className="waveDiv zIndexLow">
            <svg className="waveSvg" viewBox="0 24 150 24" preserveAspectRatio="none">
                ...
                <g>
                    <use className="wave" xlinkHref="#wave" fill={props.theme.svgColors[0]} x="50" y="0" opacity="0.45"></use>
                    <use className="wave" xlinkHref="#wave" fill={props.theme.svgColors[1]} x="50" y="2" opacity="0.7"></use>
