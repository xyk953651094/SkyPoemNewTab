    ...
    return (
        <div className="waveDiv zIndexLow">
            <svg className="waveSvg" viewBox="0 24 150 24" preserveAspectRatio="none">
                ...
                <g>
                    <use className="wave" href="#wave" fill={props.theme.svgColors[0]} x="50" y="0"></use>
                    <use className="wave" href="#wave" fill={props.theme.svgColors[1]} x="50" y="2"></use>
                    <use className="wave" href="#wave" fill={props.theme.svgColors[2]} x="50" y="4"></use>
                </g>
            </svg>
        </div>
    );
